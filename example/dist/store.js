...
var del = function (state, action) {
    var contacts = state.contacts;
    var index = contacts.findIndex(function (contact) { return contact.id === action.payload; });
    if (index !== -1) {
...
var edit = function (state, action) {
    var contacts = state.contacts;
    var index = contacts.findIndex(function (contact) { return contact.id === action.payload; });
    if (index !== -1) {
...
var contactFactory = function (name, phone) {
    if (name === void 0) { name = 'lee'; }
...
var query = function () {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, take('query')];
                case 1:
                    _a.sent();
                    mock = [
                    ...
                    return [4 /*yield*/, requestMock(mock)];
                case 2:
                    payload = _a.sent();
                    return [4 /*yield*/, put({ type: 'set', payload: payload })];
                case 3:
                    _a.sent();
                    return [2 /*return*/];
            }
...
var edit$1 = function () {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, takeEvery('editAsync', function (action) {
                        return __awaiter(this, void 0, void 0, function () {
                            var mockData, payload;
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0:
                                        mockData = action.payload;
                                        if (!action.payload.id) {
                                            mockData = __assign({}, mockData, { id: Math.random() });
                                        }
                                        return [4 /*yield*/, requestMock(mockData)];
                                    case 1:
                                        payload = _a.sent();
                                        return [4 /*yield*/, put({ type: 'edit', payload: payload })];
                                    case 2:
                                        _a.sent();
                                        return [2 /*return*/];
                                }
...
var del$1 = function () {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, takeEvery('delAsync', function (action) {
                        return __awaiter(this, void 0, void 0, function () {
                            var result;
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0:
                                        if (!action.payload.id)
                                            return [2 /*return*/];
                                        return [4 /*yield*/, requestMock(true)];
                                    case 1:
                                        result = _a.sent();
                                        if (!result) return [3 /*break*/, 3];
                                        return [4 /*yield*/, put({ type: 'del', payload: action.payload.id })];
                                    case 2:
                                        _a.sent();
                                        _a.label = 3;
                                    case 3: return [2 /*return*/];
...
var pop = function () {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, takeEvery('popAsync', function (action) {
                        return __awaiter(this, void 0, void 0, function () {
                            var contacts, last, result;
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0: return [4 /*yield*/, select(function (state) { return state.contacts; })];
                                    case 1:
                                        contacts = _a.sent();
                                    ...
                                    case 2:
                                        ...
                                        return [4 /*yield*/, put({ type: 'del', payload: last.id })];
                                    case 3:
                                        _a.sent();
                                        _a.label = 4;
...
var root$1 = function () {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, all([query, edit$1, del$1, pop])];
                case 1:
                    _a.sent();
                    return [2 /*return*/];
            }
...
var run = function () {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, withStoreShow(function () {
                        console.log('query');
                        store.dispatch({ type: 'query' });
                    })];
                case 1:
                    _a.sent();
                    return [4 /*yield*/, withStoreShow(function () {
